...
bool Device::init_client(char* ip, char* port, const char* topic_name, uint32_t session_key){
        this->ip = ip;
    this->port = port;
    ...
    if (!uxr_init_udp_transport(&this->transport, UXR_IPv4, ip, port))
    {
    ...
    sprintf(topic_xml_1, topic_xml_1_1, topic_name);
    ...
    const char *topic_xml_2_1 = "<dds>"
                                ...
                                "</topic>"
                                "</dds>";
    sprintf(topic_xml_2, topic_xml_2_1, topic_name);
    ...
    sprintf(datawriter_xml, datawriter_xml_1, topic_name);
    ...
    sprintf(datareader_xml, datareader_xml_1, topic_name);
...
bool Device::send_cmd(const char *buf)
{
